...
from timer_module.router import router as timer_router
...
app.include_router(timer_router, prefix="/timer", tags=["定时模块"])


@app.get("/test/{test_id}", summary="测试接口", response_model=VersionResp)
